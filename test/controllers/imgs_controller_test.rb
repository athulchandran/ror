...
class ImgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create img" do
    assert_difference('Img.count') do
      post imgs_url, params: { img: { description: @img.description, image: @img.image, title: @img.title } }
    end
  ...
  test "should update img" do
    patch img_url(@img), params: { img: { description: @img.description, image: @img.image, title: @img.title } }
